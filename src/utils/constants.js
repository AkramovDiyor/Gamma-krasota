...
export const MASTERS = [
  {
    ...
    name: 'Анна',
    role: 'Топ-стилист',
    avatar: '/assets/img/barbervumen1.jpeg',
    coverPhoto: '/assets/img/barbervumen1.jpeg', // Фото в работе / портрет
    rating: 4.9,
    reviews: 124,
    ...
    portfolio: [
      { id: 1, image: '/assets/img/svadba.webp', title: 'Балаяж на длинные волосы', category: 'Окрашивание' },
      { id: 2, image: '/assets/img/svadba.webp', title: 'Каскад с чёлкой', category: 'Стрижка' },
      { id: 3, image: '/assets/img/svadba.webp', title: 'Вечерняя укладка', category: 'Укладка' },
    ],
    schedule: {
  ...
  },
  {
    ...
    avatar: '/assets/img/barbervumen2.jpeg',
    coverPhoto: '/assets/img/barbervumen2.jpeg',
    rating: 5.0,
    reviews: 89,
    ...
    portfolio: [
      { id: 1, image: '/assets/img/svadba.webp', title: 'Аиртач блонд', category: 'Окрашивание' },
      { id: 2, image: '/assets/img/svadba.webp', title: 'Шатуш на каштановые', category: 'Окрашивание' },
      { id: 3, image: '/assets/img/svadba.webp', title: 'Тонирование в пепельный', category: 'Окрашивание' },
    ],
    schedule: {
  ...
  },
  {
    ...
    avatar: '/assets/img/barbervumen3.jpg',
    coverPhoto: '/assets/img/barbervumen3.jpg',
    rating: 4.8,
    reviews: 201,
    ...
    portfolio: [
      { id: 1, image: '/assets/img/svadba.webp', title: 'Французский маникюр', category: 'Маникюр' },
      { id: 2, image: '/assets/img/svadba.webp', title: 'Минимализм + стразы', category: 'Дизайн' },
      { id: 3, image: '/assets/img/svadba.webp', title: 'Педикюр с покрытием', category: 'Педикюр' },
    ],
    schedule: {
      mon: { start: 9, end: 21, available: true },
      tue: { start: 9, end: 21, available: true },
  ...
  },
  {
    ...
    name: 'Дмитрий',
    role: 'Барбер',
    avatar: '/assets/img/barber1.webp',
    coverPhoto: '/assets/img/barber1.webp',
    rating: 4.9,
    reviews: 156,
    ...
    portfolio: [
      { id: 1, image: '/assets/img/faed.webp', title: 'Фейд + текстура', category: 'Стрижка' },
      { id: 2, image: '/assets/img/faed.webp', title: 'Оформление бороды', category: 'Барбер' },
      { id: 3, image: '/assets/img/faed.webp', title: 'Классика с пробором', category: 'Стрижка' },
    ],
    schedule: {
  ...
  },
  {
    ...
    name: 'Дмитрий',
    role: 'Барбер',
    avatar: '/assets/img/barber2.webp',
    coverPhoto: '/assets/img/barber2.webp',
    rating: 4.9,
    reviews: 156,
    bio: 'Мужские стрижки с характером. Чёткие линии, плавные переходы, идеальная борода.',
    specialties: ['Мужские стрижки', 'Оформление бороды', 'Королевское бритьё'],
  ...
  },
  {
    ...
    name: 'Дмитрий',
    role: 'Барбер',
    avatar: '/assets/img/barber3.webp',
    coverPhoto: '/assets/img/barber3.webp',
    rating: 4.9,
    reviews: 156,
    bio: 'Мужские стрижки с характером. Чёткие линии, плавные переходы, идеальная борода.',
    specialties: ['Мужские стрижки', 'Оформление бороды', 'Королевское бритьё'],
